...
class ImmutableListUtilsTest{
    ...
    /*
    * Проверяем добавление элементов в иммутабельный список
    ...
    */
    ...
    /*
    * Проверяем добавление элементов пустой в иммутабельный список
    ...
    */
    ...
    /*
    * Проверяем добавление пустого в список
    * Ожидаем в результирующем списке должны присутствовать элементы из списка с элементами
    */
    @Test
    fun appendEmptyList() {
    ...
    /*
    * Проверяем добавление пустого списка в пустой список
